...
namespace XDSToXML
{
  ...
  void
  Comprobante_ (::std::ostream& os,
                const ::XDSToXML::Comprobante& x, 
  ...
  void
  Comprobante_ (::xercesc::XMLFormatTarget& ft,
                const ::XDSToXML::Comprobante& x, 
                const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
                const ::std::string& e = "UTF-8",
                ::xml_schema::flags f = 0);
  ...
  Comprobante_ (const ::XDSToXML::Comprobante& x, 
                const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
                ::xml_schema::flags f = 0);

  void
  operator<< (::xercesc::DOMElement&, const Comprobante&);

  void
  operator<< (::xercesc::DOMElement&, const CfdiRelacionados&);

  void
  operator<< (::xercesc::DOMElement&, const Emisor&);

  void
  operator<< (::xercesc::DOMElement&, const Receptor&);

  void
  operator<< (::xercesc::DOMElement&, const Conceptos&);

  void
  operator<< (::xercesc::DOMElement&, const Impuestos&);

  void
  operator<< (::xercesc::DOMElement&, const Complemento&);

  void
  operator<< (::xercesc::DOMElement&, const Addenda&);
  ...
  void
  operator<< (::xercesc::DOMElement&, const Serie&);

  void
  operator<< (::xercesc::DOMAttr&, const Serie&);
  ...
  void
  operator<< (::xercesc::DOMElement&, const Folio&);

  void
  operator<< (::xercesc::DOMAttr&, const Folio&);
  ...
  void
  operator<< (::xercesc::DOMElement&, const Sello&);

  void
  operator<< (::xercesc::DOMAttr&, const Sello&);
  ...
  void
  operator<< (::xercesc::DOMElement&, const NoCertificado&);

  void
  operator<< (::xercesc::DOMAttr&, const NoCertificado&);
  ...
  void
  operator<< (::xercesc::DOMElement&, const Certificado&);

  void
  operator<< (::xercesc::DOMAttr&, const Certificado&);
  ...
  void
  operator<< (::xercesc::DOMElement&, const CondicionesDePago&);

  void
  operator<< (::xercesc::DOMAttr&, const CondicionesDePago&);

  void
  operator<< (::xml_schema::list_stream&,
              const CondicionesDePago&);

  void
  operator<< (::xercesc::DOMElement&, const TipoCambio&);

  void
  operator<< (::xercesc::DOMAttr&, const TipoCambio&);
  ...
  void
  operator<< (::xercesc::DOMElement&, const Confirmacion&);

  void
  operator<< (::xercesc::DOMAttr&, const Confirmacion&);
  ...
  void
  operator<< (::xercesc::DOMElement&, const CfdiRelacionado&);

  void
  operator<< (::xercesc::DOMElement&, const Nombre&);

  void
  operator<< (::xercesc::DOMAttr&, const Nombre&);
  ...
  void
  operator<< (::xercesc::DOMElement&, const NumRegIdTrib&);

  void
  operator<< (::xercesc::DOMAttr&, const NumRegIdTrib&);
  ...
  void
  operator<< (::xercesc::DOMElement&, const Concepto&);

  void
  operator<< (::xercesc::DOMElement&, const Retenciones&);

  void
  operator<< (::xercesc::DOMElement&, const Traslados&);
  ...
  void
  operator<< (::xercesc::DOMElement&, const Impuestos1&);

  void
  operator<< (::xercesc::DOMElement&, const InformacionAduanera&);

  void
  operator<< (::xercesc::DOMElement&, const CuentaPredial&);

  void
  operator<< (::xercesc::DOMElement&, const ComplementoConcepto&);

  void
  operator<< (::xercesc::DOMElement&, const Parte&);

  void
  operator<< (::xercesc::DOMElement&, const NoIdentificacion&);

  void
  operator<< (::xercesc::DOMAttr&, const NoIdentificacion&);
  ...
  void
  operator<< (::xercesc::DOMElement&, const Cantidad&);

  void
  operator<< (::xercesc::DOMAttr&, const Cantidad&);
  ...
  void
  operator<< (::xercesc::DOMElement&, const Unidad&);

  void
  operator<< (::xercesc::DOMAttr&, const Unidad&);
  ...
  void
  operator<< (::xercesc::DOMElement&, const Descripcion&);

  void
  operator<< (::xercesc::DOMAttr&, const Descripcion&);
  ...
  void
  operator<< (::xercesc::DOMElement&, const Retencion&);

  void
  operator<< (::xercesc::DOMElement&, const Traslado&);

  void
  operator<< (::xercesc::DOMElement&, const Traslados1&);

  void
  operator<< (::xercesc::DOMElement&, const Retenciones1&);

  void
  operator<< (::xercesc::DOMElement&, const NumeroPedimento&);

  void
  operator<< (::xercesc::DOMAttr&, const NumeroPedimento&);
  ...
  void
  operator<< (::xercesc::DOMElement&, const Numero&);

  void
  operator<< (::xercesc::DOMAttr&, const Numero&);
  ...
  void
  operator<< (::xercesc::DOMElement&, const InformacionAduanera1&);

  void
  operator<< (::xercesc::DOMElement&, const TasaOCuota&);

  void
  operator<< (::xercesc::DOMAttr&, const TasaOCuota&);
  ...
  void
  operator<< (::xercesc::DOMElement&, const Traslado1&);

  void
  operator<< (::xercesc::DOMElement&, const Retencion1&);

  void
  operator<< (::xercesc::DOMElement&, const Base&);

  void
  operator<< (::xercesc::DOMAttr&, const Base&);
